...
def view_model():
    _DEFAULT_ITEMS = [
        {"id": 1, "status": "To Do", "title": "List saved todo items", "last_edited": datetime(2021, 3, 31, 13, 46, 34, 58000)},
        {"id": 2, "status": "In Progress", "title": "List in progress items", "last_edited": datetime(2021, 3, 31, 13, 46, 34, 58000)},
        {"id": 3, "status": "Complete", "title": "List completed items", "last_edited": datetime(2000, 4, 10, 13, 46, 34, 58000)},
        {"id": 4, "status": "Complete", "title": "List completed items", "last_edited": datetime(2023, 4, 30, 13, 46, 34, 58000)}
        ]
...
def test_recent_done_items(view_model):
    ...
    for item in view_model.recent_done_items:
        assert (item['status'] == 'Complete') and (item['last_edited'] > datetime_yesterday)
