...
`docker run -p 9000:5000 --name DEV --env-file .envdocker --mount type=bind,source="$(pwd)"/todo-app,target=/todo-app todo:dev`
...
Run the container with  
`docker run -p 8080:5000 --name PROD --env-file .envdocker todo:prod`
